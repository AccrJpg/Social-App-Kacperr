...
const SignUp = (props) => {
    ...
    const validate = () => {
        ...
        if (!/^[A-Z0-0._%+-]+@[A-Z0-0.-]+\.[A-Z]{2,}$/i.test(formData.email.trim())) {

            validationErrors.email = true;
            setErrors((prevErrors) => {
                return { ...prevErrors, email: "Not a valid email" }
            })
        ...
        if (formData.password.trim().length < 6) {
            ...
            validationErrors.password = true;
            setErrors((prevErrors) => {
                return { ...prevErrors, password: "Password should have at least one special character" }
            })
        } else {
        ...
        return (!validationErrors.username && !validationErrors.email && !validationErrors.password && !validationErrors.confirmPasswords);
    };
    ...
    return (
        <div className="signUp">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="username" placeholder="username" onChange={handleInputChange}></input>
